...
import HomePage, { exampleArticles } from "./Page/HomePage";
...
import { fetchArticlesSuccess } from "./store/slices/articleSlice";
...
function App() {
  ...
  useEffect(() => {
    ...
    dispatch(fetchArticlesSuccess(exampleArticles));
  }, [dispatch]);
